...
const curriculum = {
    1: [
        ...
        { code: 'U25PE110IT', name: 'Skill Development Course-I', hours: 1 },
        { code: 'U25HS011EH', name: 'English Language Skills Lab', hours: 2 },
        { code: 'U25BS111PH', name: 'Semiconductor Lab', hours: 2 },
        { code: 'U25ES111IT', name: 'Python Programming Lab', hours: 2 },
        { code: 'U25ES011EE', name: 'Basic Electrical Engineering Lab', hours: 2 }
    ],
    2: [
        ...
        { code: 'U25HS020EH', name: 'Human Values & Ethics - I', hours: 1 },
        { code: 'U25PE210IT', name: 'Skill Development Course - II', hours: 1 },
        { code: 'U25BS011CH', name: 'Chemistry Lab', hours: 2 },
        { code: 'U25ES211IT', name: 'Basic Electronics Lab', hours: 2 },
        { code: 'U25ES231IT', name: 'Structured Programming Lab', hours: 2 }
    ],
    3: [
        ...
        { code: 'U24HS320EH', name: 'Skill Development - I (Comm)', hours: 1 },
        { code: 'U24PE310IT', name: 'Skill Development - II (Tech)', hours: 1 },
        { code: 'U24PC311IT', name: 'Data Structures Lab', hours: 2 },
        { code: 'U24PC321IT', name: 'OOP Lab', hours: 2 },
        { code: 'U24PC331IT', name: 'Network Engineering Lab', hours: 2 }
    ],
    4: [
        ...
        { code: 'U24BS430MA', name: 'Skill Development - III (Aptitude)', hours: 1 },
        { code: 'U24PE410IT', name: 'Skill Development - IV (Tech)', hours: 1 },
        { code: 'U24PC421IT', name: 'DBMS Lab', hours: 2 },
        { code: 'U24PC431IT', name: 'DAA Lab', hours: 2 },
        { code: 'U24PC441IT', name: 'Full Stack Development Lab', hours: 2 }
    ],
    5: [
        ...
        { code: 'U23HS510EH', name: 'Skill Development - V (Comm)', hours: 1 },
        { code: 'U23PE510IT', name: 'Skill Development - VI (Tech)', hours: 1 },
        { code: 'U23PC511IT', name: 'Computer Networks Lab', hours: 2 },
        { code: 'U23PC521IT', name: 'AI/ML Lab', hours: 2 },
        { code: 'U23PC531IT', name: 'Microprocessors Lab', hours: 2 },
        { code: 'U23PC541IT', name: 'Operating Systems Lab', hours: 2 }
    ],
    6: [
        ...
        { code: 'U23HS630EH', name: 'Skill Development - VII (Verbal)', hours: 1 },
        { code: 'U23PE610IT', name: 'Skill Development - VIII (Tech)', hours: 1 },
        { code: 'U23PC611IT', name: 'Software Engineering Lab', hours: 2 },
        { code: 'U23PC621IT', name: 'Distributed Systems Lab', hours: 2 },
        { code: 'U23PC631IT', name: 'Neural Networks Lab', hours: 2 },
        { code: 'U23PW619IT', name: 'Theme Based Project', hours: 2 }
    ],
    7: [
        ...
        { code: 'U22PC711IT', name: 'Compiler Design Lab', hours: 2 },
        { code: 'U22PC721IT', name: 'Cloud Computing Lab', hours: 2 },
        { code: 'U22PE711IT', name: 'Prof Elective - I Lab', hours: 2 },
        { code: 'U22PE721IT', name: 'Prof Elective - II Lab', hours: 2 },
        { code: 'U22PW719IT', name: 'Project Seminar', hours: 2 }
    ],
    8: [
